...
/// <summary>
/// Modal dialog for reviewing and deleting individual sweep captures.
...
/// </summary>
public partial class SweepEditWindow : Window
{
    ...
    /// </summary>
    private HashSet<SweepCapture> ComputeViolators()
    {
        var violators = new HashSet<SweepCapture>();
